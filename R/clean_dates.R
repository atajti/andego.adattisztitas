# dátumkezelés, gyakori nonstandard esetek bevonásával
clean_dates <- function(chr_vect, correct_yy_flag=TRUE){
  ...
  if(length(setdiff(which(is.na(date_vect)),
    ...
    warning(paste0("Néhány dátumot nem sikerült értelmezni. Az első: ",
